...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(338, 218)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(80, 40, 160, 80))
        ...
        self.btn_math_part = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.btn_math_part.setObjectName("btn_math_part")
        self.verticalLayout.addWidget(self.btn_math_part)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_math_part.setText(_translate("MainWindow", "Мат. часть"))
